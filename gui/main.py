...
class Main:
    ...
    def drawGui(self):
        ...
        editmenu.add_command(label="Line", command=self.drawLine)
        editmenu.add_separator()
        editmenu.add_command(label="Resistor", command= lambda : self.addElement("R") )
        editmenu.add_command(label="Capacitor", command= lambda : self.addElement("C") )
        editmenu.add_command(label="Inductor", command= lambda : self.addElement("L") )
        editmenu.add_command(label="Voltage", command= lambda : self.addElement("V") )
        editmenu.add_command(label="Current", command= lambda : self.addElement("I") )
        menubar.add_cascade(label="Edit", menu=editmenu)
        
        simulatemenu = Menu(menubar, tearoff=0)
        simulatemenu.add_command(label="Run", command=self.simulate)
